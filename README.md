# AI_Learning
Record my ai learning plan.
Day1 2026/1/3

Large AI Model: 
    Claude Code (Chinese Tutorial): https://claudecode.tangshuang.net/
    Claude Code in Action: https://anthropic.skilljar.com/claude-code-in-action
    Claude Code in Action(Chinese): https://note.mowen.cn/detail/1_ZEnLT5BCYVsix54iB77

Making videos:
    Automating Faceless Video Content: https://github.com/cporter202/automate-faceless-content
    AI Short Video Factory: https://github.com/YILS-LIN/short-video-factory

Python tutorials: 
    Python training is for JPMorgan: https://github.com/jpmorganchase/python-training
